...
Status: planned reference integration; ingestion planning, a testable ingest runner, a minimal HTTP fetcher and a reconciliation loop are implemented, but no webhook server or exporter is complete.
